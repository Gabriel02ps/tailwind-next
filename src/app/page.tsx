        ...
        >
          <div className="grid grid-cols-form gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <Input.Root>
                <Input.Control defaultValue="Pereira" />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="gabriel02ps@gmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="grid grid-cols-form gap-3 pt-5">
            ...
            <div className="flex items-start gap-5">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-violet-25">
